<div class="page-head">
    ...
    <a class="btn" href="/persons/create<?= $profile !== 'all' ? '?profile=' . urlencode((string) $profile) : '' ?>"><?= e($createLabel ?? 'Nueva persona') ?></a>
</div>
...
<div class="card">
    <form method="get" action="/persons" class="filters">
        ...
        <div class="filter-actions">
            ...
            <a class="btn-secondary btn" href="/persons<?= $profile !== 'all' ? '?profile=' . urlencode((string) $profile) : '' ?>">Limpiar</a>
        </div>
    </form>
</div>
        ...
        <tbody>
            <?php foreach ($persons as $row): ?>
                <tr>
                    ...
                    <td><a class="btn-secondary btn-sm" href="/persons/edit?id=<?= e($row['id']) ?><?= $profile !== 'all' ? '&profile=' . urlencode((string) $profile) : '' ?>">Editar</a></td>
                </tr>
            <?php endforeach; ?>
            <?php if (!$persons): ?>
